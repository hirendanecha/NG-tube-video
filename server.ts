...
export function app(): express.Express {
  ...
  const distFolder = join(process.cwd(), 'tube-dist/ng-tube/browser');
  ...
  const template = fs
    .readFileSync(
      path.join(join(process.cwd(), 'tube-dist/ng-tube/browser'), 'index.html')
    )
    .toString();
    ...
    res.render(
      ...
      async (err, html) => {
        ...
        var seo: any = {
          ...
          image:
            'https://video.nudegirls.tube/assets/Healing-Tube-Logo.jpg',
          site: 'https://video.nudegirls.tube/',
          url: 'https://video.nudegirls.tube' + params,
        ...
        if (
          ...
          const talent = {
            ...
            image: post?.thumbfilename || post?.metaimage || post?.imageUrl || 'https://video.nudegirls.tube/assets/Healing-Tube-Logo.jpg',
          };
          seo.title = talent.name;
          seo.description = strip_html_tags(talent.description);
          seo.image = talent.image;
